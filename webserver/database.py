...
def drone():
    ...
    redis_server.hset(drone_key, 'id', droneID)
    redis_server.hset(drone_key, 'ip', droneIP)
    redis_server.hset(drone_key, 'longitude', drone_longitude)
    redis_server.hset(drone_key, 'latitude', drone_latitude)
    redis_server.hset(drone_key, 'status', drone_status)
